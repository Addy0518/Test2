    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<MyOfficeExcuteionLog>(entity =>
        {
            ...
            entity.Property(e => e.DeLogExDateTime)
                .HasDefaultValueSql("(getdate())")
                .HasAnnotation("Relational:DefaultConstraintName", "DF_MOTC_DataExchangeLog_DeLog_ExDateTime")
                .HasColumnType("datetime")
            ...
            entity.Property(e => e.DeLogIsCustomDebug)
                .HasAnnotation("Relational:DefaultConstraintName", "DF_MOTC_DataExchangeLog_DeLog_isCustomDebug")
            ...
            entity.Property(e => e.DeLogVerifyNeeded)
                .HasDefaultValue(false)
                .HasAnnotation("Relational:DefaultConstraintName", "DF_MyOffice_ExcuteionLog_DeLog_verifyNeeded")
