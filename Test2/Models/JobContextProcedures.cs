...
namespace Test2.Models
{
    ...
    {
        private IJobContextProcedures _procedures;

        public virtual IJobContextProcedures Procedures
        {
            get
            {
                if (_procedures is null) _procedures = new JobContextProcedures(this);
                return _procedures;
            }
            set
            {
        ...
        public IJobContextProcedures GetProcedures()
        {
            return Procedures;
        }
    }

    public partial class JobContextProcedures : IJobContextProcedures
    {
        private readonly JobContext _context;

        public JobContextProcedures(JobContext context)
        {
            _context = context;
        }
        ...
        public virtual async Task<List<usp_ACPD_CreateResult>> usp_ACPD_CreateAsync(string inBox_Json, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            var parameterreturnValue = new SqlParameter
            {
                ParameterName = "returnValue",
            ...
            var _ = await _context.SqlQueryAsync<usp_ACPD_CreateResult>("EXEC @returnValue = [dbo].[usp_ACPD_Create] @InBox_Json = @InBox_Json", sqlParameters, cancellationToken);
